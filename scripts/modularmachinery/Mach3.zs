...
recipes.addShaped(<modularmachinery:blockinputbus> , [[<modularmachinery:blockcasing>,<modularmachinery:blockcasing>,<modularmachinery:blockcasing>],[<modularmachinery:blockcasing>,<contenttweaker:fzd>,<modularmachinery:blockcasing>],[<modularmachinery:blockcasing>,<modularmachinery:blockcasing>,<modularmachinery:blockcasing>]]);
...
for i in 0 .. modout.length{
    recipes.addShapeless(modout[i] * 1 ,[<contenttweaker:fzd>,modin[i]]);
}
